...
class Base(Configuration):
    ...
    "topmenu_links": [
        ...
        {"name": "Support", "url": "https://github.com/terry-brooksjr/the-dozens-django/issues", "new_window": True},
...
class Production(Base):
    ...
    CSRF_TRUSTED_ORIGINS = values.ListValue(
        default=["https://yo-momma.io", "https://www.yo-momma.io","https://dozens.nyc3.cdn.digitaloceanspaces.com/*"],
        environ=True,
        environ_prefix=None,
