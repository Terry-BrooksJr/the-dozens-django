...
class ApiRequest:
    ...
    def test_endpoint(self, category, nsfw):
       return requests.get(url=f"{self.get_url}/api/{category}", params={"nsfw": nsfw}, headers=self.set_headers())
        
        
        
if __name__ == "__main__":
    tester = ApiRequest("https://api.yo-momma.io/","b31ec6397d8b3c8f959f5b6150f27c47bc02acec" )
