...
class Base(Configuration):
    ...
    ROOT_URLCONF = values.Value("thedozens.urls", environ=False)
    WSGI_APPLICATION = values.Value("thedozens.wsgi.application", environ=False)
    ...
    SPECTACULAR_SETTINGS = values.DictValue(
        {
    ...
    EMAIL_BACKEND = values.Value("mailer.backend.DbBackend", environ=False)
...
class Production(Base):
    ...
    # SECTION Start - Production Database and Caching
...
class Development(Base):
    ...
    def setup(cls):
        super().setup()
        if cls.DEBUG:
            cls.MIDDLEWARE.insert(0, "kolo.middleware.KoloMiddleware")
    ...
    # SECTION Start - Development Database and Caching
    DATABASES = values.DictValue(
        {
            "default": {
                "ENGINE": "django_cockroachdb",
