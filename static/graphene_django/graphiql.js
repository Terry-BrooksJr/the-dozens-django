(function (
  ...
  // Use graphqlEndpoint from GRAPHENE_SETTINGS if set (avoids posting to the
  // playground URL when the playground lives at a sub-path of the API).
  var fetchURL = GRAPHENE_SETTINGS.graphqlEndpoint || locationQuery(otherParams);
